...
(id, username, email, is_deleted, role_id, created_at, updated_at)
VALUES
(1, 'johndoe', 'john.doe@example.com', false, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2, 'janedoe', 'jane.doe@example.com', false, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(3, 'guestuser', 'guest@example.com', false, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
